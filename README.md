...
При покупке фьючерса вы не платите всю стоимость сразу - биржа блокорует **гарантийное обеспечение** (**ГО**) на вашем счёте. Оно отличается для разных фьючерсов и составляет 5-10% от цены. Если фьючерс поставочный, то к дате экспирации у вас на счету должно быть достаточно средств для полной оплаты. Ежедневно у покупателя и продавца начисляется/списывается вариационная маржа, равная изменению рыночной цены фьючерса.
