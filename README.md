...
Облигация - денежное обязательство эмитента облигации перед её владельцем. Проще говоря - кредит или долговая расписка. Облигация имеет **срок** выплаты, номинальную стоимость (**номинал**) - это основное тело долга, которое должен вернуть эмитент в конце срока, а также **купон** - это процент, который выплачивается дополнительно к телу долга. Купон выплачивается раз в год/квартал/месяц. Срок облигации может быть как 1 год так и 2, 3, 5, 10 лет. На протяжении всего срока жизни облигации владелец может продавать и покупать облигацию по свободной рыночной цене. Цена облигации пишется в процентах от номинала: например, цена 95 от олигации номиналом 1000 рублей означает 950 рублей. Виды облигаций:
 ...
 - **Корпоративные облигации** - выпущены от имени частных/гос компаний, например облигации ~~"Трансаэро"~~ ~~"Пересвет"~~ ГК "ПИК"
...
Для популяризации инвестирования среди населения - в российской практике введён особый тип инвестиционного счёта, по которому можно получить налоговый вычет 13% на вносимые средства, либо налоговую льготу на полученный доход.
Вычет первого типа - налоговая вернет 13% от суммы, размещенной на депозите, но придется уплатить НДФЛ от прибыли, полученной в результате торгов.
Вычет второго типа - налоговая ничего не возвращает, но освобождает от НДФЛ весь полученный на ИИС доход.
...
### Slack-канал для инвесторов и трэйдеров

Для получения инвайта, отправь на «traderok @ zoho.com» (убрав пробелы из адреса) скрин, на котором виден этот гайд и твой терминал, где куплены акции/облигации/фонды на сумму от 50 тыс руб.

## Литература и темы которые полезно знать

### Ценные бумаги
* Вэбинары Сергея Спирина с этого канала https://www.youtube.com/channel/UCpFFEzNskcqWf1E3D-WkdUg
...
## PS: Задавайте вопросы, уточняйте, а также приветствуются пул реквесты в этот гайд.
