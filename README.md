...
Торговля на бирже осуществляется через компании-брокеры. В них клиенты открывают брокерские счета и управляют сделками. 

Крупнейшие дисконтные американские брокеры, это [**Interactive Brockers**](http://www.interactivebrokers.com) и [**Ameritrade**](http://www.amtd.com/). Последний приостановил открытие счетов для клиентов из России.
...
> У тинькова конские комиссии и упрощённый функционал. У открытия самые дешёвые тарифы.

Торговля может осуществляться разными способами:

 - через терминал для десктопа, обычно это **Quik**, **MT5** или свой терминал
