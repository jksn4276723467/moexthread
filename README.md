...
Торговля на бирже осуществляется через компании-брокеры. В них клиенты открывают брокерские счета и управляют сделками. В россии крупнейшие брокеры это [**Открытие**](http://open-broker.ru/), [**БКС**](http://bcs.ru/) и [**Финам**](http://www.finam.ru/). Также есть брокеры от банков, такие как [Тиньков](https://www.tinkoff.ru/invest/), [Альфабанк](https://www.alfadirect.ru/), [Сбербанк](http://www.sberbank.ru/ru/person/investments/broker_service/marketsandservices). Выбирайте понравившиеся вам тарифы и условия и открывайте счёт. У некоторых брокеров это можно сделать удалённо, используя аккаунт в "[Госуслугах](https://www.gosuslugi.ru/)"
