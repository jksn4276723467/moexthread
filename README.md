...
~~Говно без задач.~~ Для популяризации инвестирования среди населения - в российской практике введён особый тип инвестиционного счёта, по которому можно получить налоговый вычет 13% на вносимые средства. Клиент сам выбирает будет ли этот вычет производится из НДФЛ, уплаченного по основному месту работы или из дохода, полученного на ИИС. ИИС имеет ограничения:

 - у одного человека может быть только один ИИС
 - максимальная сумма вносимых средств - 400к рублей в год
 - нельзя выводить средства минимум 3 года, иначе вычет придётся вернуть
