...
Финансовые инструменты могут быть базовыми, например [акции](#Акции-shares) и облигации, так и производными (**деривативы**) - это фьючерсы и опционы. Если ты ньюфаг или мусульманин - тебе не рекомендуется торговать деривативами.
